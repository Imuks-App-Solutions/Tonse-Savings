...
const Cards = () => {
  return (
    <div className="flex w-full md:flex-row flex-col items-center justify-center gap-2">
      {/* Card 1-Left */}
      <div className="flex items-center bg-white shadow-md md:w-1/2 w-full flex-col border rounded-md p-3 gap-2">
        <div className="flex flex-row  py-4 justify-between w-full items-center">
          ...
          <div className="flex flex-row w-fit items-center justify-end">
            ...
            <p className=" text-sm font-bold text-gray-600">per month</p>
          </div>
        </div>
          ...
          <div className="flex flex-row gap-3 text-sm">
            ...
            <div className="flex flex-col justify-between w-full items-center">
              <div className="flex gap-2 items-center">
                ...
                <button className=" border border-black py-[1px] rounded-2xl font-bold px-2">
                  Default
                </button>
              </div>
